...
import HorizontalProfileCard from "../../../../src/components/features/profiles/HorizontalProfileCard";
...
describe("HorizontalProfileCard", () => {
    const profileID = 0;
            ...
            queryClientWrapper({
                children: (
                    <ModalContext.Provider value={value}>
                        <HorizontalProfileCard profileID={profileID} />
